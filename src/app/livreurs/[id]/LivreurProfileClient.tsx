...
import { toWaLink, toTelHref } from "@/lib/phone";
...
function whatsappUrl(phone: string) {
  return toWaLink(phone, "Bonjour, j'ai trouvé votre profil sur Waselli et je souhaite vous contacter pour une livraison.");
}
