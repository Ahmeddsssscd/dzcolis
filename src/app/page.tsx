...
const features: { title: string; desc: string; icon: React.ReactNode }[] = [
  ...
  { title: "Sécurisé",    desc: "Paiement séquestre, assurance jusqu'à 50 000 DA, profils vérifiés.",
...
const intlRoutes = [
  { country: "France",    flag: "FR", route: "Alger \u2192 Paris",       price: "4 500 DA" },
  { country: "Espagne",   flag: "ES", route: "Oran \u2192 Madrid",       price: "3 800 DA" },
  { country: "Belgique",  flag: "BE", route: "Alger \u2192 Bruxelles",   price: "4 200 DA" },
  { country: "Allemagne", flag: "DE", route: "Alger \u2192 Berlin",      price: "6 500 DA" },
  { country: "Italie",    flag: "IT", route: "Constantine \u2192 Milan",  price: "3 500 DA" },
];
