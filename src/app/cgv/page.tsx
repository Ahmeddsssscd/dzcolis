    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-dz-green to-dz-green-dark text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-green-100 text-lg">
            Les règles qui encadrent l&apos;utilisation de la plateforme DZColis et les transactions entre expéditeurs et transporteurs.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-dz-gray-500 text-sm mb-10">
          Dernière mise à jour : avril 2026 — Ces conditions s&apos;appliquent à toute utilisation de la plateforme DZColis.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              Les présentes Conditions Générales de Vente et d&apos;Utilisation (ci-après « CGV ») régissent l&apos;utilisation de la plateforme DZColis, accessible à l&apos;adresse <span className="text-dz-green font-medium">www.dzcolis.dz</span>, et l&apos;ensemble des services proposés par DZColis. Elles constituent le socle contractuel unique régissant les relations entre DZColis et tout utilisateur de la plateforme, qu&apos;il soit expéditeur, transporteur ou simple visiteur.
            </p>
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              DZColis est une place de marché collaborative qui met en relation des <strong className="text-dz-gray-700">expéditeurs</strong> souhaitant envoyer des colis avec des <strong className="text-dz-gray-700">transporteurs particuliers ou professionnels</strong> effectuant des trajets correspondants sur le territoire algérien et à l&apos;international.
            </p>
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              <strong className="text-dz-gray-800">DZColis n&apos;est pas un transporteur.</strong> Elle agit exclusivement en tant qu&apos;intermédiaire technique facilitant la mise en relation entre les parties et la sécurisation des paiements. À ce titre, DZColis ne saurait en aucun cas être considérée comme partie au contrat de transport conclu entre l&apos;expéditeur et le transporteur, ni être tenue responsable de l&apos;exécution ou de l&apos;inexécution dudit contrat.
            </p>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              L&apos;accès aux services de DZColis nécessite la création d&apos;un compte utilisateur. L&apos;inscription est gratuite et réservée aux personnes physiques majeures (âgées de 18 ans révolus) ou aux personnes morales régulièrement constituées selon le droit algérien.
            </p>
            <div className="space-y-2 text-dz-gray-600 text-sm leading-relaxed">
              ...
              <ul className="list-disc pl-5 space-y-1 text-dz-gray-500">
                ...
                <li>Notifier immédiatement DZColis de toute utilisation non autorisée de son compte ;</li>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              L&apos;inscription et la publication d&apos;annonces sur DZColis sont entièrement gratuites. DZColis perçoit une <strong className="text-dz-gray-700">commission de 10%</strong> sur le montant de chaque transaction validée entre un expéditeur et un transporteur. Cette commission rémunère les services d&apos;intermédiation, de mise en relation, de sécurisation du paiement et de support client fournis par DZColis.
            </p>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              Afin de garantir la sécurité des transactions, DZColis utilise un système de <strong className="text-dz-gray-700">paiement par séquestre</strong> (escrow) fonctionnant comme suit :
            </p>
            <ol className="list-decimal pl-5 space-y-2 text-dz-gray-500 text-sm">
              ...
              <li>Les fonds sont conservés de manière sécurisée par DZColis pendant toute la durée du transport. Aucune partie ne peut y accéder unilatéralement.</li>
              ...
              <li>Le paiement est alors libéré automatiquement au profit du transporteur (90% du montant, déduction faite de la commission DZColis de 10%).</li>
            </ol>
            <p className="text-dz-gray-600 text-sm leading-relaxed mt-3">
              En cas de litige non résolu dans un délai de <strong className="text-dz-gray-700">72 heures</strong> suivant la date de livraison prévue, DZColis intervient en tant que médiateur selon la procédure décrite à l&apos;article 10. Les fonds sont maintenus en séquestre jusqu&apos;à résolution définitive du différend.
            </p>
            <p className="text-dz-gray-600 text-sm leading-relaxed mt-3">
              Si l&apos;expéditeur ne confirme pas la réception dans les 48 heures suivant la livraison confirmée par le transporteur, le paiement est automatiquement libéré en faveur du transporteur, sauf opposition formelle notifiée au support DZColis avant l&apos;expiration de ce délai.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <div className="bg-dz-gray-50 rounded-xl p-4 text-sm text-dz-gray-600 mb-3">
              ...
              <ul className="list-disc pl-5 space-y-1 text-dz-gray-500">
                ...
                <li>Elle est horodatée et conservée par DZColis pendant une durée de 10 ans ;</li>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <div className="space-y-3 text-dz-gray-600 text-sm leading-relaxed">
              ...
              <p>
                En cas de contenu non déclaré, illicite ou dangereux, l&apos;expéditeur assume l&apos;entière responsabilité civile et pénale en découlant et s&apos;engage à indemniser DZColis, le transporteur et tout tiers qui subirait un préjudice du fait de ce contenu. DZColis est expressément et irrévocablement dégagée de toute responsabilité pour le contenu des colis.
              </p>
              <p>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            <h2 className="text-xl font-bold text-dz-gray-800 mb-4">
              <span className="text-dz-green mr-2">8.</span>Responsabilité de DZColis
            </h2>
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              DZColis agit exclusivement en qualité d&apos;<strong className="text-dz-gray-800">intermédiaire technique</strong> et de place de marché numérique. À ce titre :
            </p>
            <ul className="list-disc pl-5 space-y-2 text-dz-gray-500 text-sm mb-3">
              <li>DZColis n&apos;est pas partie au contrat de transport conclu entre l&apos;expéditeur et le transporteur ;</li>
              <li>DZColis ne contrôle pas physiquement les colis et n&apos;est pas en mesure de vérifier leur contenu ;</li>
              <li>DZColis décline toute responsabilité pour les dommages résultant d&apos;un manquement d&apos;un utilisateur à ses obligations contractuelles ou légales ;</li>
              <li>DZColis décline toute responsabilité pour la perte, le vol, la détérioration ou la confiscation d&apos;un colis dont le contenu est illicite, non conforme ou non déclaré ;</li>
              <li>DZColis décline toute responsabilité pour les retards, annulations ou inexécutions imputables au transporteur.</li>
            </ul>
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 text-sm">
              <p className="font-semibold text-orange-800 mb-1">Plafond de responsabilité de DZColis</p>
              <p className="text-orange-700">
                Dans les cas où la responsabilité de DZColis serait malgré tout retenue par une juridiction compétente, cette responsabilité est expressément limitée au montant de la commission perçue par DZColis sur la transaction concernée (soit 10% du montant de la transaction), à l&apos;exclusion de tout dommage indirect, consécutif, accessoire, spécial ou punitif. Ce plafond s&apos;applique indépendamment de la théorie juridique invoquée.
              </p>
            </div>
            <p className="text-dz-gray-600 text-sm leading-relaxed mt-3">
              La responsabilité de DZColis se limite au bon fonctionnement technique de la plateforme et à la bonne gestion du séquestre conformément aux présentes CGV.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              DZColis ne saurait être tenue responsable de tout manquement à ses obligations contractuelles résultant d&apos;un événement de force majeure, au sens de l&apos;article 127 du Code civil algérien, c&apos;est-à-dire tout événement imprévisible, irrésistible et extérieur aux parties.
            </p>
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed">
              En cas de force majeure, DZColis s&apos;engage à informer les utilisateurs dans les meilleurs délais et à prendre toutes les mesures raisonnables pour minimiser les perturbations. Les obligations de DZColis sont suspendues pendant la durée de l&apos;événement de force majeure. Si cet événement dure plus de 60 jours, chacune des parties peut résilier les engagements en cours sans indemnité.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <div className="space-y-3 text-dz-gray-600 text-sm leading-relaxed">
              <div>
                ...
                <p>
                  En cas de litige entre utilisateurs ou entre un utilisateur et DZColis, les parties s&apos;engagent à tenter de résoudre le différend à l&apos;amiable avant tout recours judiciaire. À cette fin, DZColis propose un service de <strong className="text-dz-gray-700">médiation interne</strong> accessible depuis la plateforme ou via l&apos;adresse <a href="mailto:litiges@dzcolis.dz" className="text-dz-green hover:underline">litiges@dzcolis.dz</a>.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-dz-gray-700 mb-1">10.2 Procédure de médiation</h3>
                <ul className="list-disc pl-5 space-y-1 text-dz-gray-500">
                  <li>La partie lésée notifie son grief par écrit à DZColis avec tous les éléments justificatifs ;</li>
                  <li>DZColis dispose de <strong className="text-dz-gray-700">15 jours ouvrables</strong> pour répondre et proposer une solution ;</li>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              DZColis permet la mise en relation pour des envois à destination ou en provenance de l&apos;étranger. Pour ces envois, les dispositions suivantes s&apos;appliquent en complément des présentes CGV :
            </p>
            <div className="space-y-3 text-dz-gray-600 text-sm leading-relaxed">
              <div>
                <h3 className="font-semibold text-dz-gray-700 mb-1">11.1 Responsabilité douanière</h3>
                <p>
                  L&apos;expéditeur est seul responsable du respect des réglementations douanières algériennes et de celles du pays de destination. Il lui appartient de s&apos;informer des restrictions d&apos;importation et d&apos;exportation applicables aux articles expédiés. DZColis n&apos;assume aucune responsabilité en cas de saisie, confiscation ou destruction d&apos;un colis par les autorités douanières de quelque pays que ce soit.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-dz-gray-700 mb-1">11.2 Droits et taxes de douane</h3>
                <p>
                  Les droits de douane, taxes à l&apos;importation, TVA et autres prélèvements fiscaux exigibles dans le pays de destination sont à la charge exclusive du destinataire ou de l&apos;expéditeur selon les conditions convenues entre eux. DZColis n&apos;intervient à aucun titre dans le règlement de ces sommes et ne saurait en être tenue responsable.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-dz-gray-700 mb-1">11.3 Articles interdits dans le pays de destination</h3>
                <p>
                  L&apos;expéditeur doit s&apos;assurer que les articles expédiés ne sont pas interdits ou soumis à des restrictions particulières dans le pays de destination. Toute confiscation ou pénalité découlant du non-respect de cette obligation est supportée exclusivement par l&apos;expéditeur. DZColis se réserve le droit de suspendre le compte de tout utilisateur dont les envois auraient fait l&apos;objet d&apos;une saisie douanière.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-dz-gray-700 mb-1">11.4 Réglementation sur les changes</h3>
                <p>
                  Conformément à la réglementation algérienne sur les changes, les transactions en devises étrangères sont soumises aux règles édictées par la Banque d&apos;Algérie. DZColis ne peut être utilisée pour contourner la réglementation sur les changes ou faciliter des transferts de fonds illicites.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-dz-gray-200 p-6">
            ...
            <p className="text-dz-gray-600 text-sm leading-relaxed mb-3">
              Pour toute question relative aux présentes CGV, pour signaler un abus ou pour demander la clôture de votre compte, vous pouvez contacter DZColis aux coordonnées suivantes :
            </p>
