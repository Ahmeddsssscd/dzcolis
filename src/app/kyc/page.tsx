    ...
    <div>
      ...
      {file ? (
        ...
        <button onClick={() => inputRef.current?.click()}
          className="w-full border-2 border-dashed border-dz-gray-200 hover:border-dz-green/40 hover:bg-green-50/30 rounded-xl p-6 text-center transition-all group">
