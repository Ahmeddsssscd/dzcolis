        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://facebook.com/dzcolis" target="_blank" rel="noopener noreferrer" aria-label="Facebook Waselli"
              ...
              <a href="https://instagram.com/dzcolis" target="_blank" rel="noopener noreferrer" aria-label="Instagram Waselli"
              ...
              <a href="https://twitter.com/dzcolis" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter) Waselli"
